...
using UnityEngine;
    ...
    public class DurksStompCollider : DamageCollider
    {
        ...
        {
            GameObject stompVFX = Instantiate(durkCharacterManager.durkCombatManager.durkImpactVFX, transform.position, durkCharacterManager.durkCombatManager.durkImpactVFX.transform.rotation);
