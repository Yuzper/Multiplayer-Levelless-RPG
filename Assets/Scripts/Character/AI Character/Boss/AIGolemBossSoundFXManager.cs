 ...
 * Hence for each boss there would be a new class. However I just called this class "AIGolemBossSoundFXManager".
 ...
 */
public class AIGolemBossSoundFXManager : CharacterSoundFXManager
{
