 ...
 * Hence for each boss there would be a new class. However I just called this class "AIGolemBossCombatManager".
...
public class AIGolemBossCombatManager : AICharacterCombatManager
{
    ...
    [SerializeField] GolemBossMeleeDamageCollider rightHandDamageCollider;
    [SerializeField] GolemBossMeleeDamageCollider leftHandDamageCollider;
